      ...
      <Router>
        ...
        <div className="landing">
          <div className="title-card">
            <p className="fullname">J I M M Y GRANADINO</p>
            <p className="role">Full Stack Developer &nbsp;
              <svg width="1em" height="1em" viewBox="0 0 16 12" class="bi bi-keyboard-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
