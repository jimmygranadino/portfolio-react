...
const About = () => {
    ...
    return (
        <section>
            <div className="content-grid night dark-mode light-mode">
                ...
                <div className="content skills-box night dark-mode light-mode">
                    <h1 className="headings night dark-mode light-mode" id="skills">SKILLS:</h1>
                        <div className="skill-list night dark-mode light-mode">
                        <p className="content-text night dark-mode light-mode">
