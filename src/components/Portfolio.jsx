                ...
                <div className="portfolio-grid">
                        ...
                        <div className="port-one">
                            <span className="port-title-card">
                                <span className="port-title-text">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="port-icons" viewBox="0 0 16 16">
                    ...
                    <a href="https://jimmygranadino.github.io/badgerdodger/" target="_blank" rel="noopener noreferrer">
                        <div className="port-three">
                            <span className="port-title-card">
                                <span className="port-title-text">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1.3em" height="1.3em" fill="currentColor" className="port-icons" viewBox="0 -2 16 16">
