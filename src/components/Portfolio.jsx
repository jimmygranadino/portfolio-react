                ...
                <div className="portfolio-grid">
                    <a href="https://wonderful-haibt-c86035.netlify.app/" target="_blank" rel="noopener noreferrer">
                        <div className="port-one">
                            <span className="port-title-card">
                                <span className="port-title-text">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-chat-dots-fill" viewBox="0 0 16 16">
                            ...
                            <span className="port-body-card">
                                <span className="content-text">Light-weight chatroom web app utilizing Socket.io</span>
                            </span>
                        </div>
                    </a>
                    <br/>
                    <a href="https://colcities.herokuapp.com/" target="_blank" rel="noopener noreferrer">
                        <div className="port-two">
                            <span className="port-title-card">
                                <span className="port-title-text">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-currency-exchange" viewBox="0 0 16 16">
