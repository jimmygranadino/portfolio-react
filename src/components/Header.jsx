...
const Header = () => {
    ...
    return (
        <section id="card">
            <div className="landing-card night dark-mode light-mode">
                <p className="fullname night dark-mode light-mode">JIMMY GRANADINO</p>
                <hr />
                <p className="role night dark-mode light-mode">Software & Analytics</p>
                
                <p className="location-text night dark-mode light-mode">
                    ...
                    Software Engineering / Business Intellgence / Analytic Reporting
                </p>
            </div>
        </section>
    )
